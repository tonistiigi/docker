...
// ResolverFunc returns a call back function to resolve "registry-mirrors" and
// "insecure-registries" for buildkit
func (daemon *Daemon) ResolverFunc() docker.RegistryHosts {
	var (
