...
func (s *DockerDaemonSuite) TestHttpsInfo(c *check.C) {
	...
	daemonArgs := []string{"--host", s.d.sock(), "--tlsverify", "--tlscacert", "fixtures/https/ca.pem", "--tlscert", "fixtures/https/client-cert.pem", "--tlskey", "fixtures/https/client-key.pem"}
...
func (s *DockerDaemonSuite) TestHttpsInfoRogueCert(c *check.C) {
	...
	daemonArgs := []string{"--host", s.d.sock(), "--tlsverify", "--tlscacert", "fixtures/https/ca.pem", "--tlscert", "fixtures/https/client-rogue-cert.pem", "--tlskey", "fixtures/https/client-rogue-key.pem"}
	out, err := s.d.CmdWithArgs(daemonArgs, "info")
