...
func executeProcess(t *testing.T, contextDir string) {
	modifiableCtx := &testRemote{root: contextDir}
...
func (r *testRemote) Hash(path string) (string, error) {
	return "", errors.New("not implemented")
}

func (r *testRemote) Root() string {
	return r.root
}
func (r *testRemote) Close() error {
	return errors.New("not implemented")
}
func (r *testRemote) Remove(p string) error {
