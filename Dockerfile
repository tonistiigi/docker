...
# Install containerd
ENV CONTAINERD_COMMIT 8e9d62813e56c46b768ac43b0a791bfc7fd71956
RUN set -x \
	&& export GOPATH="$(mktemp -d)" \
	&& git clone https://github.com/crosbymichael/containerd.git "$GOPATH/src/github.com/docker/containerd" \
